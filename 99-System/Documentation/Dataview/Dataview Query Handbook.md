...
- **Nekonzistentní cesty k složkám**: `FROM "02 Dots"` vs `FROM "02-Knowledge"`
...
| 1,000-10,000    | Folder-based filtering | `FROM "02-Knowledge"`          |
| >10,000         | Kombinace + LIMIT      | `FROM "02-Knowledge" LIMIT 50` |

### Indexování a cacheování
- **Omezení rozsahu dotazů**: `FROM "02-Knowledge/Concepts"` místo globálního `FROM ""`
