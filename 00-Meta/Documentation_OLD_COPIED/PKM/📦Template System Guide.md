...
|------|--------|-----------|-------------|
| `atomic` | `02-Dots/100-Atomics` | `atomic.md` | Knowledge units, ideas, concepts |
...
| `prompt` | `07-Prompts` | `prompt.md` | AI prompt templates |
| `person` | `02-Dots/300-People` | `base.md`* | People, contacts |
| `place` | `02-Dots/400-Places` | `base.md`* | Locations |
| `tool` | `02-Dots/200-Tools` | `base.md`* | Tools, software, methods |
| `area` | `02-Dots/500-Areas` | `base.md`* | Areas of responsibility |
