...
├── 02-Dots/         ← Knowledge units
│   ├── 100-Atomics/ ← Ideas, concepts, insights
│   ├── 200-Tools/   ← Tool documentation
│   ├── 300-People/  ← People notes
│   ├── 400-Places/  ← Location notes
│   └── 500-Areas/   ← Areas of responsibility
├── 03-Efforts/      ← Projects and goals
│   ├── On/          ← Active with deadline
│   ├── Ongoing/     ← Active, no specific deadline
│   └── Simmering/   ← Someday/maybe
...
4. **Folder Templates**: Configure `+Inbox` → `Templates/Quick Capture - Inbox.md`
...
- [ ] **Review `00-Meta/` about sections** — Personalize dashboard descriptions
...
- Adjust effort subfolders (`On/Ongoing/Simmering`) to match your project style
...
```
📥inbox → draft (03-Efforts/On) → review → published → 📦archived
```
