...
## Short 
```
cd /cesta/k/rozbalene/slozce/Origin-
git init git add . 
git commit -m "Initial commit: Origin release" 
git branch -m main 
...
```bash
cd /cesta/k/tvoji/slozce/Origin-Prod
```
...
## **1. Připojení k vzdálenému repositáři (např. GitHub)**
