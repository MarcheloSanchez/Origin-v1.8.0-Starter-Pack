...
**Pro Tip:** Run this every Sunday during [[🧠GTD Weekly Review]]
...
**Command:** Open [[🧠GTD Weekly Review]]
...
**Command:** Open [[📈Performance Metrics Dashboard]]
...
1. Calculates expensive metrics:
   ...
   - Hub identification
   - Growth trends
2. Writes to `00-Meta/_Metrics Cache.md`
...
2. Or: Move to `02-Dots/X/` → Review during weekly review
