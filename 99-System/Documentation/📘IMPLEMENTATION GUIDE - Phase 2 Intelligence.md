...

{
  ...
  "rules": [
    {
      "tag": "#💡idea",
      "folder": "02-Knowledge/Ideas"
    },
    {
      "tag": "#🚀project",
      "folder": "03-Efforts/Active"
    },
    {
      "tag": "#📚source",
      "folder": "04-Sources"
    ...
    {
      "tag": "#🤝meeting",
      "folder": "02-Knowledge/Meetings"
    },
    {
      "tag": "#👤contact",
      "folder": "02-Knowledge/People"
    },
    {
      "tag": "#🧬health",
      "folder": "02-Knowledge/Health"
    },
    {
      "tag": "#💰finance",
      "folder": "02-Knowledge/Financial"
    },
    {
      "status": "✅completed",
...
def create_duplicate_report(duplicates):
    ...
    timestamp = datetime.now().strftime("%Y-%m-%d")
    report_path = os.path.join(VAULT_PATH, "99-System/Documentation", f"Duplicate Report {timestamp}.md")
